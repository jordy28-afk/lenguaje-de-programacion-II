...
class producto:
    ...
    def actualizar_estock(sel,nuevo_stock):
        sel.stock = nuevo_stock
        print("\nstock actualizado correctamente")

#crear objestos de la clase producto
producto1 =producto("arroz",3.50,100)
producto2 =producto("azucar",4.50,50)
producto3 =producto("aceite",8.00,100)
producto4 =producto("leche",3.50,100)

#mostrar informavcion del producto
producto1.mostar_informacion()
producto2.mostar_informacion()
producto3.mostar_informacion()
producto4.mostar_informacion()

#actualizar precio y estock
producto1.actualizar_precio(4)
producto1.actualizar_estock(110)
...
class SistemaMercado:
    def __init__(self, root):
        ...
        self.productos.append(Producto("Arroz", 3.50, 100))
        self.productos.append(Producto("Azúcar", 4.50, 50))
        self.productos.append(Producto("Aceite", 8.00, 100))
        self.productos.append(Producto("Leche", 3.50, 100))
    ...
    def mostrar_productos(self):
        ...
        # Stock
        ttk.Label(frame_form, text="Stock (unidades):").grid(row=2, column=0, sticky=tk.W, pady=10)
        ...
        # Imagen decorativa
        frame_imagen = tk.Frame(panel_izquierdo, bg=self.colores["fondo_panels"])
        frame_imagen.pack(fill=tk.X, pady=20)
    ...
    def mostrar_estadisticas(self):
        ...
        if producto_mas_caro:
            info += f"\nProducto más caro: {producto_mas_caro.nombre} (S/. {producto_mas_caro.precio:.2f})"
        
        if producto_mas_stock:
            info += f"\nProducto con más stock: {producto_mas_stock.nombre} ({producto_mas_stock.stock} unidades)"
